...
import UsageProfileList from "../../../components/lists/DataList";
...
export default function UsageProfile(props) {
  return (
    ...
    >
      <div style={{ ...cabinDetailsStyle.componentTitle }}>Usage Profile</div>
...
function ComponentSelector(props) {
  if (props.usageProfile.length == 0) return <NoDataComponent />;
  else
    return (
      <UsageProfileList data={props.usageProfile} uiResult={props.uiResult} />
    );
}
